...
model_url = "s3://sbabs-sagemaker-models/sagemaker/notebook-xgboost-dm/output/xgboost-2023-02-28-20-31-59-652/output/model.tar.gz"
...
def register_model_package_version():
...
# register_model_package_version();
